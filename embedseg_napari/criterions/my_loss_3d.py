...
from embedseg_napari.criterions.lovasz_losses import lovasz_hinge


class SpatialEmbLoss_3d(nn.Module):

    def __init__(self, grid_z = 32, grid_y=1024, grid_x=1024, pixel_z = 1, pixel_y=1, pixel_x=1, one_hot=False, n_sigma=3, foreground_weight=1):
        super().__init__()
